...
rs[, Vol_agua_tratada :=  as.numeric(fnc_converte(AG007...Volume.de.água.tratada.em.ETAs))
                        + as.numeric(fnc_converte(AG015...Volume.de.água.tratada.por.simples.desinfecção))
                        + as.numeric(fnc_converte(AG018...Volume.de.água.tratada.importado))
                        - as.numeric(fnc_converte(AG019...Volume.de.água.tratada.exportado))
                        ]
rs[, ES006 := as.numeric(fnc_converte(ES006...Volume.de.esgotos.tratado))]
